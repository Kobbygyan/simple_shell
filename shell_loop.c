...
/**
 * hsh - Main loop for shell program
 * @info: Pointer to the info_t structure
 * @av: Array of command line arguments
 *
 * Return: Return value of the last executed builtin command
 */
...
/**
 * find_builtin - Find and execute a builtin command
 * @info: Pointer to the info_t structure
 *
 * Return: Return value of the executed builtin command,
